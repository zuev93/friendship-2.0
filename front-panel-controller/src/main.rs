...
static FB1: StaticCell<BufferedDisplay> = StaticCell::new();
...
async fn main(spawner: Spawner) {
    ...
    let fb1 = FB1.init(BufferedDisplay::new());
    ...
    spawner.must_spawn(tasks::render_display1::render_display1_task(
        fb1,
        hw.displays,
        &input_state.meter_state,
    ));
